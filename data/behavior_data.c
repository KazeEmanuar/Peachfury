...
git push*/
/*and when you pull a pr, run this command
git pull*/
#include "sm64.h"
...
// No operation. Unused.
#define CALL_SEGMENTED(func) BC_B(0x18), BC_PTR(func)
...
const BehaviorScript bhvUnderwaterdoor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    LOAD_COLLISION_DATA(underwaterdoor_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(underwaterdoorcode),
    END_LOOP(),
};


const BehaviorScript bhvSwitchPlane[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
    CALL_NATIVE(waterplane),
    END_LOOP(),
};
...
const BehaviorScript bhvTowerDoor[] = {
    ...
    SET_HITBOX(/*Radius*/ 35, /*Height*/ 65),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvParticleEffect[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
...
const BehaviorScript bhvStandardBlue[] = {
    BEGIN(OBJ_LIST_LEVEL),
    BILLBOARD(),
...
const BehaviorScript bhvDoorWarp2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_INT(oInteractType, INTERACT_WARP_DOOR),
    GOTO(bhvDoor + 1 + 1),
};
...
const BehaviorScript bhvFlameSmall[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
...
const BehaviorScript bhvFlameMedium[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
...
const BehaviorScript bhvBouncingFireball[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 300, /*Downwards offset*/ 0),
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvBouncingFireballFlame[] = {
    ...
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 25, /*Downwards offset*/ 25),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -200, /*Bounciness*/ -70,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    BILLBOARD(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvGoombaBubble[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_goomba_bubble_loop),
    END_LOOP(),
};

const BehaviorScript bhvYoshiBubble[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_yoshi_bubble_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvMacroUkiki[] = {
    ...
    ANIMATE(0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 60, /*Gravity*/ -400, /*Bounciness*/ -50,
...
extern void demolishmonke(void);
const BehaviorScript bhvDemolishUkiki[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Ukiki - common:
    ...
    LOAD_ANIMATIONS(oAnimations, ukiki_seg5_anims_05015784),
    SCALE(0, 200),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 60, /*Gravity*/ -400, /*Bounciness*/ -5,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(demolishmonke),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};
...
const BehaviorScript bhvSmallPenguin[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_ACTIVE_FROM_AFAR)),
    DROP_TO_FLOOR(),
    LOAD_ANIMATIONS(oAnimations, penguin_seg5_anims_05008B74),
    ANIMATE(0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -200, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 0, /*Buoyancy*/ -50, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    SET_HITBOX(/*Radius*/ 40, /*Height*/ 40),
    SET_FLOAT(oDrawingDistance, 4000),
...
extern void cheepcheepcode(void);
const BehaviorScript bhvBub[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, cheepcheepnew_anims),
    ANIMATE(0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 40, /*Downwards offset*/ 20),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
    CALL_NATIVE(cheepcheepcode),
    END_LOOP(),
};
...
extern void zooshark(void);
const BehaviorScript bhvSushiShark[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, sushinew_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 50, /*Downwards offset*/ 50),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 3),
    ANIMATE(0),
...
const BehaviorScript bhvBlueCoinSwitch[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(blue_coin_switch_collision),
    BEGIN_LOOP(),
...
const BehaviorScript bhvObjectWaveTrail[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT), OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
...
extern void bhv_dino_nose_particle(void);
const BehaviorScript bhvDinoNoseParticle[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_dino_nose_particle),
    END_LOOP(),
};
...
const BehaviorScript bhvCannonClosed[] = {
    ...
    BEGIN_LOOP(),
        CALL_NATIVE(despawnonBparam1Stars),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
const BehaviorScript bhvMessagePanel[] = {
    ...
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 110),
    SET_INT(oWoodenPostTotalMarioAngle, 0),
    BEGIN_LOOP(),
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(load_object_collision_model),
    CALL_NATIVE(bhv_signpost),
    SET_INT(oInteractStatus, 0),
    END_LOOP(),
};
...
const BehaviorScript bhvSignOnWall[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_INT(oInteractionSubtype, INT_SUBTYPE_CPTLOG),
...
const BehaviorScript bhvBananaZoo[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    GOTO(bhvBetaHoldableObject),
};
...
const BehaviorScript bhvExplosion2[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO )),
    BILLBOARD(),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    ...
    SET_INT(oIntangibleTimer, 0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 300, /*Height*/ 300, /*Downwards offset*/ 300),
    SET_INT(oAnimState, -1),
    CALL_NATIVE(bhv_explosion_init),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_explosion_loop),
...
const BehaviorScript bhvNormalCap[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE| OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
...
const BehaviorScript bhvJrbFloatingPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(floatwood_collision),
    SET_FLOAT(oFloatingPlatformUnkFC, 64),
    SET_HOME(),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_floating_platform_loop),
...
extern void mantacode(void);
const BehaviorScript bhvMantaRay[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, mantanew_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(mantacode),
    END_LOOP(),
};
...
const BehaviorScript bhvMipsEND[] = {
    SET_INT(oBobombBuddyRole, 0),
    SET_HOME(),
    CALL_NATIVE(bhv_bobomb_buddy_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvMips[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bunny_anims),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    DROP_TO_FLOOR(),
    SCALE(0, 200),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 150),
    ANIMATE(0),
    GOTO(bhvMipsEND), //CuckyDev: Undefined behavior
};

const BehaviorScript bhvMipsDance[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bunny_anims),
...
const BehaviorScript bhvKoopa[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -400, /*Bounciness*/ 0, /*Drag strength*/ 0,
                    /*Friction*/ 1000, /*Buoyancy*/ -25, /*Unused*/ 0, 0),
...
const BehaviorScript bhvGoomba[] = {
    ...
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 300, /*Gravity*/ -400, /*Bounciness*/ -50,
...
extern void tireSwingGoomba(void);
const BehaviorScript bhvGoombaTireSwin[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HOME(),
    LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
    BEGIN_LOOP(),
    CALL_NATIVE(tireSwingGoomba),
    END_LOOP(),
};

extern void bhv_goomba_sleep(void);
const BehaviorScript bhvGoombaSleeping[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
    ...
    SET_HOME(),
    SPAWN_CHILD(/*Model*/ MODEL_BUBBLE, /*Behavior*/ bhvGoombaBubble),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_goomba_sleep),
    END_LOOP(),
};

extern void bunnygoomba(void);
const BehaviorScript bhvGoombaBunny[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, goombabunny_anims),
    SET_FLOAT(oGraphYOffset, -5),
    ANIMATE(0),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 300, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bunnygoomba),
    END_LOOP(),
};

const BehaviorScript bhvGoombaKing[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 220, /*Height*/ 400),
    LOAD_ANIMATIONS(oAnimations, goombaking_anims),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 32000),
    SPAWN_CHILD(/*Model*/ MODEL_BUBBLE, /*Behavior*/ bhvGoombaBubble),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 400, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
    CALL_NATIVE(goombakingcode),
    SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

const BehaviorScript bhvGoombaKingCrown[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_COLLISION_DATA(goombaking_collision),
    SCALE(0, 175),
    BEGIN_LOOP(),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvGoombaTroop[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
    ...
    CALL_NATIVE(bhv_goomba_init),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_goomba_update_2),
    END_LOOP(),
};

const BehaviorScript bhvGoombaStarSpawn[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    BEGIN_LOOP(),
    CALL_NATIVE(goombaSpawnerCode),
    END_LOOP(),
};
...
const BehaviorScript bhvChainChomp[] = {
    ...
    ANIMATE(0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 120, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 0,
...
extern void unagiJokes(void);
const BehaviorScript bhvUnagi[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                     | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, jokeUnagi_anims),
    ANIMATE(1),
    SCALE(/*Unused*/ 0, /*Field*/ 300),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(unagiJokes),
    END_LOOP(),
};
...
extern void cptPiano(void);
const BehaviorScript bhvMadPiano[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, mad_piano_seg5_anims_05009B14),
    SET_INT(oDamageOrCoinValue, 3),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 200, /*Height*/ 150),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    BEGIN_LOOP(),
    CALL_NATIVE(cptPiano),
    END_LOOP(),
};
...
const BehaviorScript bhvRedBird[] = {
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    GOTO(bhvFreeBird) //CuckyDev: Undefined behaviour
};
...
// INTERACT_BOUNCE_TOP
extern const struct Animation *const bouncyflower_anims[];
...
extern const Collision screw_collision[];
const BehaviorScript bhvScrew[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(screw_collision),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
    CALL_NATIVE(screwcode),
    END_LOOP(),
};
...
const BehaviorScript bhvWobblerock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_HOME(),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    CALL_NATIVE(bhv_platform_normals_init),
    LOAD_COLLISION_DATA(wobblerock_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_tilting_inverted_pyramid_loop),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvCloudflower[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
    // CALL_NATIVE(scavengersign),
...
extern const Collision cloudspawn_collision[];
...
extern const Collision icequad_collision[];
const BehaviorScript bhvIceQuad[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST),
    LOAD_COLLISION_DATA(icequad_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(icequad_funciton),
    END_LOOP(),
};

const BehaviorScript bhvSubmarine[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(submarine_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(submarinecode),
    END_LOOP(),
};
...
const BehaviorScript bhvDoorswitch[] = {
    BEGIN(OBJ_LIST_SURFACE),
    // Floor switch - common:
    SET_INT(oBehParams2ndByte, 1),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
...
/*
extern const Collision stardomedoor_collision[];
const BehaviorScript bhvDomeDoor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    // Floor switch - common:
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(stardomedoor_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_dome_door),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};*/
/*
const BehaviorScript bhvDomeRock[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
    ...
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
    CALL_NATIVE(bhv_rock_in_water),
    END_LOOP(),
};*/

const BehaviorScript bhvMartoise[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                       | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    LOAD_COLLISION_DATA(martoise_collision),
    LOAD_ANIMATIONS(oAnimations, martoise_anims),
    ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_HOME(),
    BEGIN_LOOP(),
    CALL_NATIVE(humphrey),
    END_LOOP(),
};
...
extern const Collision arrowgates_collision[];

const BehaviorScript bhvArrowgate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(arrowgates_collision),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(arrowgate_code),
    END_LOOP(),
};
...
const BehaviorScript bhvJelly[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(jellyfish_code),
    END_LOOP(),
};


const BehaviorScript bhvDonutblock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(donutblock_collision),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 6500),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(donutcode),
    END_LOOP(),
};


const BehaviorScript bhvBuzzy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_HOLDABLE | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                       | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE),
    LOAD_ANIMATIONS(oAnimations, buzzy_anims),
    ANIMATE(2),
    SET_FLOAT(oDrawingDistance, 6500),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 60, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX(/*Radius*/ 60, /*Height*/ 72),
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(buzzycode),
    END_LOOP(),
};


const BehaviorScript bhvDustBackwards[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_INT(oAnimState, -1),
    CALL_NATIVE(bhv_backdust_init),
    DELAY(1),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_backdust_loop),
    ADD_INT(oAnimState, 1),
    END_LOOP(),
};

//bparam1&0x7f is size
//bparam1&0x80 is controller?
///bparam2-4 are RGBs
const BehaviorScript bhvLight[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(crystallightcode),
    END_LOOP(),
};
...
const BehaviorScript bhvMirror[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(mirrorcode),
    END_LOOP(),
};
extern void happyholecode(void);
const BehaviorScript bhvHappyHoleVisuals[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(happyholecode),
    END_LOOP(),
};

const BehaviorScript bhvMirroredObject[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
    END_LOOP(),
...
const BehaviorScript bhvYoshiCart[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(yoshicart_collision),
    LOAD_ANIMATIONS(oAnimations, yoshicart_anims),
    ANIMATE(0),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -25, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshicart),
    END_LOOP(),
};

const BehaviorScript bhvTalkyboy[] = {
    SET_INT(oBobombBuddyRole, 0),
    SET_HOME(),
    CALL_NATIVE(bhv_bobomb_buddy_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvNipperTalk[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
const BehaviorScript bhvNipperNoTalk[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    LOAD_ANIMATIONS(oAnimations, nipper_anims),
    SCALE(0, 80),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ...
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
    CALL_NATIVE(eatingnipper),
    END_LOOP(),
};
const BehaviorScript bhvNipperDance[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SCALE(0, 800),
    LOAD_ANIMATIONS(oAnimations, nipper_anims),
...
const BehaviorScript bhvTextureAnims[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(textureanim),
    END_LOOP(),
};


const BehaviorScript bhvMouseTalk[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oGraphYOffset, -33),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, lilmouse_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 60),
...
const BehaviorScript bhvMouseTalk2[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oGraphYOffset, -33),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, lilmouseOW_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 60),
...
const BehaviorScript bhvMinewall[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(minewall_collision),
...
const BehaviorScript bhvMinewallOW[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(OWcrytals_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(despawnonBparam1Stars),
    END_LOOP(),
...
const BehaviorScript bhvBridgebreak[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(bridgepound_collision),
    LOAD_ANIMATIONS(oAnimations, bridgepound_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(breakbridge),
    END_LOOP(),
};

const BehaviorScript bhvBoonard[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, boonard_anims),
    ANIMATE(0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(boonard),
...
const BehaviorScript bhvBoonardBoss[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, boonard_anims),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(boonardboss),
    END_LOOP(),
};

const BehaviorScript bhvBoonardHelp[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, boonard_anims),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(boonardhelp),
    END_LOOP(),
};

const BehaviorScript bhvBoonardTrigger[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    BEGIN_LOOP(),
        CALL_NATIVE(boonardtrigger),
    END_LOOP(),
};

const BehaviorScript bhvNipperKey[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(nipperkey),
    END_LOOP(),
};


const BehaviorScript bhvNipperdoor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(nipperdoor_collision),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(nipperdoor),
    END_LOOP(),
};


const BehaviorScript bhvPiranhaBoss[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW )),
    SET_FLOAT(oDrawingDistance, 12000),
    LOAD_ANIMATIONS(oAnimations, NavalPiranha_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(piranhaboss),
    END_LOOP(),
};
const BehaviorScript bhvPiranhaVines[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    //LOAD_COLLISION_DATA(piranhavines_collision),
    LOAD_ANIMATIONS(oAnimations, piranhavines_anims),
    ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(piranhavine),
     //   CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
const BehaviorScript bhvPiranhaAttack[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, piranhavineswithint_anims),
    ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(vinewhip),
    END_LOOP(),
};
const BehaviorScript bhvPiranhaCutsceneDummy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_REPEAT(70),
    ADD_FLOAT(oPosY, 20),
...
const BehaviorScript bhvHitbox[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_HITBOX(/*Radius*/ 390, /*Height*/ 900),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oDamageOrCoinValue, 3),
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
...
const BehaviorScript bhvTNT[] = {
    ...
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(bhv_beta_holdable_object_loop),
    CALL_NATIVE(blinkAndDeactivate),
    END_LOOP(),
};


const BehaviorScript bhvLights[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(lightsbhv),
    END_LOOP(),
};

const BehaviorScript bhvUpDownPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(updown_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(updownplatformcode),
    END_LOOP(),
};
extern void reset_mario_colors();
const BehaviorScript bhvHammer[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(hammer_collision),
        CALL_NATIVE(reset_mario_colors),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(hammercode),
    END_LOOP(),
};
...
const BehaviorScript bhvLavaSplash[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_INT(oAnimState, -1),
...
const BehaviorScript bhvNipperEnemy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW )),
    SET_HOME(),
    LOAD_ANIMATIONS(oAnimations, nipper_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -10,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX(/*Radius*/ 50, /*Height*/ 60),
    SCALE(0, 120),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(nipperenemyx),
    END_LOOP(),
};


extern const struct Animation *const yoshinew_anims[];
const BehaviorScript bhvYoshiVillager[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, yoshinew_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -400, /*Bounciness*/ -60,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    ...
    ANIMATE(0),
    SET_HOME(),
    CALL_NATIVE(yoshivillagerinitcode),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(yoshivillagercode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

const BehaviorScript bhvYoshiActSelect[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, yoshinew_anims),
    ANIMATE(0),
    BEGIN_LOOP(),//anim3 if hes selected
        CALL_NATIVE(actYoshoiCode),
    END_LOOP(),
};

extern const struct Animation *const cardboardbox_anims[];
const BehaviorScript bhvIntroBox[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_ANIMATIONS(oAnimations, cardboardbox_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(cardboardboxIntroCode),
    END_LOOP(),
};

const BehaviorScript bhvFileDisplay[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(filedisplaycode),
    END_LOOP(),

};

const BehaviorScript bhvCutsceneBowser[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bowser_seg6_anims_06057690),
    ANIMATE(0x0C),
    SET_INT(oOpacity, 0xff),
    BEGIN_LOOP(),
        CALL_NATIVE(bowsercutsceneCode),
    END_LOOP(),
};

const BehaviorScript bhvCutsceneObject[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
...
const BehaviorScript bhvCutsceneObjectFruit[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -400, /*Bounciness*/ -60,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_FLOAT(oGraphYOffset, 50),
    BEGIN_LOOP(),
        CALL_NATIVE(fruitCode),
    END_LOOP(),
};
...
const BehaviorScript bhvStargate[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 0, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(stargate_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(stargatecode),
    END_LOOP(),
};


extern void parakarrycode(void);
const BehaviorScript bhvParaKarry[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    LOAD_ANIMATIONS(oAnimations, parakarry_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(parakarrycode),
    END_LOOP(),
};
extern const Collision aircruise_collision[];
extern const struct Animation *const aircruise_anims[];
const BehaviorScript bhvAircruise[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(airCruisers),
    END_LOOP(),
};


extern void stateyosh(void);
const BehaviorScript bhvStateYosh[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    LOAD_ANIMATIONS(oAnimations, savestateYosh_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(stateyosh),
    END_LOOP(),
};

const BehaviorScript bhvBombSprite[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    BEGIN_LOOP(),
        CALL_NATIVE(bombspritecode),
    END_LOOP(),
};

extern const Collision deletebutton_collision[];
const BehaviorScript bhvDeleteButton[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    LOAD_COLLISION_DATA(deletebutton_collision),
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(deletebutton),
    END_LOOP(),
};


extern const struct Animation *const firepiranha_anims[];
const BehaviorScript bhvDeletePiranha[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 140, /*Height*/ 400),
    LOAD_ANIMATIONS(oAnimations, firepiranha_anims),
    ANIMATE(0),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(deleteplant),
    END_LOOP(),
};


const BehaviorScript bhvSpider[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_HOME(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvGrassHopper[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE  | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -200, /*Bounciness*/ 0,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(grasshopper),
    END_LOOP(),

};


const BehaviorScript bhvTurretBase[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE ),
    LOAD_COLLISION_DATA(fireturretbase_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvFireTurret[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    LOAD_COLLISION_DATA(fireturret_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(flameturret),
    END_LOOP(),
};
...
const BehaviorScript bhvExclamationMark[] = {
    ...
    BILLBOARD(),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiExclamationmarkcode),
    END_LOOP(),
};


const BehaviorScript bhvMipsArrow[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(bunnyarrows_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void pumpking(void);
const BehaviorScript bhvPumpking[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(pumpking_collision),
    SET_FLOAT(oDrawingDistance, 14000),
    BEGIN_LOOP(),
        CALL_NATIVE(pumpking),
    END_LOOP(),
};

extern void tireswing(void);
const BehaviorScript bhvTireSwing[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(tireswing_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(tireswing),
    END_LOOP(),
};



const BehaviorScript bhvChompBone[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    DROP_TO_FLOOR(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 0,
                    /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 50),
    SET_FLOAT(oGraphYOffset, 28),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(chompbone),
    END_LOOP(),
};

extern void floatboat(void);
const BehaviorScript bhvFloatBoatZoo[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(floatboat_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(floatboat),
    END_LOOP(),
};

extern void musclepengu(void);
const BehaviorScript bhvMusclePenguin[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    LOAD_ANIMATIONS(oAnimations, MusclePengu_anims),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 135, /*Height*/ 200),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(musclepengu),
    END_LOOP(),
};


extern void sneakpengu(void);
const BehaviorScript bhvSneakyPengu[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, sneakypengu_anims),
    CALL_NATIVE(makeTalkable),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 70, /*Height*/ 110),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(sneakpengu),
    END_LOOP(),
};



extern void smartpengu(void);
const BehaviorScript bhvSmartPengu[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, smartpenguin_anims),
    CALL_NATIVE(makeTalkable),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 70, /*Height*/ 165),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(smartpengu),
    END_LOOP(),
};



extern void bosspengu(void);
const BehaviorScript bhvBossPenguin[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    CALL_NATIVE(makeTalkable),
    LOAD_ANIMATIONS(oAnimations, bosspenguin_anims),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 85, /*Height*/ 165),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(bosspengu),
    END_LOOP(),
};

extern void chompgate(void);
const BehaviorScript bhvChompGate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(chompgate_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(chompgate),
    END_LOOP(),
};


extern void tablebreaking(void);
const BehaviorScript bhvTableBreaking[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(table_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(tablebreaking),
    END_LOOP(),
};


extern void wariocar(void);
const BehaviorScript bhvWarioCar[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wariocar_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(wariocar),
    END_LOOP(),
};


extern void waluigi(void);
const BehaviorScript bhvWaluigi[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oDrawingDistance, 5000),
    LOAD_ANIMATIONS(oAnimations, waluigi_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(waluigi),
    END_LOOP(),
...
extern void wariogate(void);
const BehaviorScript bhvWarioGate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wariogate_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(wariogate),
    END_LOOP(),
};

extern void safetyCloud(void);
extern const Collision cloud_collision[];
...
extern void patrolBobOmb(void);
const BehaviorScript bhvPatrollingBobOmb[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
        CALL_NATIVE(patrolBobOmb),
    END_LOOP(),
};

extern void pengucage(void);
const BehaviorScript bhvPenguCage[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(pengucage_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(pengucage),
    END_LOOP(),
};


extern void wario(void);
const BehaviorScript bhvWario[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 100),
    SET_FLOAT(oDrawingDistance, 6000),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, wario_anims),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(wario),
    END_LOOP(),
...
extern void jailukiki(void);
const BehaviorScript bhvPrisonUkiki[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Ukiki - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    ...
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(jailukiki),
    END_LOOP(),
};


extern void waterdrop(void);
const BehaviorScript bhvWaterDrop[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(waterdrop),
    END_LOOP(),
};

extern void bhv_bubbleparticleinit(void);
extern void bhv_bubbleparticleloop(void);
const BehaviorScript bhvBubbleExplosion[] = {
    BEGIN(OBJ_LIST_UNIMPORTANT),
    SET_HOME(),
    BILLBOARD(),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_bubbleparticleinit),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 10, /*Gravity*/ -200, /*Bounciness*/ 0, /*Drag strength*/ 0,
                    /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_REPEAT(10),
    CALL_NATIVE(bhv_bubbleparticleloop),
    END_REPEAT(),
    DEACTIVATE(),
};

extern void bubbledrop(void);
const BehaviorScript bhvBubbleDrop[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    BILLBOARD(),
    SET_FLOAT(oDrawingDistance, 32000),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(bubbledrop),
    END_LOOP(),
};

extern void sellguy(void);
const BehaviorScript bhvSellGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, sellguy_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(sellguy),
    END_LOOP(),
...
const BehaviorScript bhvPenguCannon[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(pengucannon_collision),
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
extern void warioTWO(void);
const BehaviorScript bhvWarioTWO[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_ACTIVE_FROM_AFAR)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 150),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 100, /*Gravity*/ -400, /*Bounciness*/ -20, /*Drag strength*/ 0,
                    /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_FLOAT(oDrawingDistance, 6000),
    LOAD_ANIMATIONS(oAnimations, wario_anims),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(warioTWO),
    END_LOOP(),
};


extern void crabKritter(void);
const BehaviorScript bhvCrabKritter[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
    SET_HOME(),
    ...
    SET_HITBOX(/*Radius*/ 40, /*Height*/ 40),
    BEGIN_LOOP(),
        CALL_NATIVE(crabKritter),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};


extern void bloopercode(void);
const BehaviorScript bhvBlooper[] = {
    ...
    SET_HITBOX(/*Radius*/ 50, /*Height*/ 100),
    BEGIN_LOOP(),
        CALL_NATIVE(bloopercode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern void smoltoisecode(void);
const BehaviorScript bhvSmoltoise[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 170, /*Height*/ 70),
    SET_FLOAT(oDrawingDistance, 6000),
    SCALE(0, 15),
    LOAD_ANIMATIONS(oAnimations, smoltoise_anims),
    ANIMATE(0),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(smoltoisecode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

const BehaviorScript bhvAirPlane[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(penguplane_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
extern void skullblockcode(void);
const BehaviorScript bhvSkullBlock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(skullblock_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(skullblockcode),
    END_LOOP(),
};


extern void spikeballcode(void);
const BehaviorScript bhvSpikeBall[] = {
    ...
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 277, /*Height*/ 554, /*Downwards offset*/ 277),
    BEGIN_LOOP(),
        CALL_NATIVE(spikeballcode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

//fishbone
extern void fishbonecode(void);
const BehaviorScript bhvFishBone[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SCALE(0,200),
    LOAD_COLLISION_DATA(fishbone_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(fishbonecode),
    END_LOOP(),
};
...
const BehaviorScript bhvLightning[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(lightning),
    END_LOOP(),
};


const BehaviorScript bhvGhostSail[] = {
    BEGIN(OBJ_LIST_DEFAULT),
};

extern void shipCannon(void);
const BehaviorScript bhvShipCannon[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(cannonbarrelcoll_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(shipCannon),
    END_LOOP(),
};

extern void ghostplatform(void);
const BehaviorScript bhvGhostPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(ghostplatform),
    END_LOOP(),
};

extern void ghostLantern(void);
const BehaviorScript bhvGhostLantern[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(ghostLantern),
    END_LOOP(),
};

extern void breakabletile(void);
const BehaviorScript bhvBreakableTile[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO|OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(floorbreak_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(breakabletile),
    END_LOOP(),
};


extern void destroybarrelcode(void);
const BehaviorScript bhvDestroyBarrel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(destroybarrel_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(destroybarrelcode),
    END_LOOP(),
};

extern void boobarrel(void);
const BehaviorScript bhvBooBarrel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(destroybarrel_collision),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(boobarrel),
    END_LOOP(),
};


extern void booGuy(void);
const BehaviorScript bhvBooGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    ...
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP),
    SET_INT(oDamageOrCoinValue, 2),
    SET_HITBOX(/*Radius*/ 60, /*Height*/ 160),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_ANIMATIONS(oAnimations, booguy_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(booGuy),
    END_LOOP(),
};
extern void booGuyPainting(void);
const BehaviorScript bhvBooGuyPainting[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                     | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(booGuyPainting),
    END_LOOP(),
};



extern void scaleFish(void);
const BehaviorScript bhvFishStupid[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    LOAD_ANIMATIONS(oAnimations, blue_fish_seg3_anims_0301C2B0),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(scaleFish),
    END_LOOP(),
};

extern void jellyblock(void);
const BehaviorScript bhvJellyBlock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(jellyblock),
    END_LOOP(),
};

extern void wallsword(void);
const BehaviorScript bhvWallSword[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                     | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 3),
    SET_HITBOX(/*Radius*/ 180, /*Height*/ 20),
    BEGIN_LOOP(),
        CALL_NATIVE(wallsword),
    END_LOOP(),
};

extern void rotatetunnel(void);
const BehaviorScript bhvTunnelShip[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(tunnel_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(rotatetunnel),
    END_LOOP(),
};
const BehaviorScript bhvTunnelShip2[] = {
    BEGIN(OBJ_LIST_SURFACE),
...
const BehaviorScript bhvChandelier[] = {
    ...
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(chandelier),
    END_LOOP(),
};


extern void pushthingy(void);
const BehaviorScript bhvPushCargo[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(pushcargobox_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(pushthingy),
    END_LOOP(),
};


extern void pushthingy2(void);
const BehaviorScript bhvPushShelf[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(pushshelf_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(pushthingy2),
    END_LOOP(),
};

extern void ropebridge(void);
const BehaviorScript bhvRopeBridge[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(ropebridge_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(ropebridge),
    END_LOOP(),
};


extern void crumblebridge(void);
const BehaviorScript bhvCrumbleBridge[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(crumblefloor_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(crumblebridge),
    END_LOOP(),
};

extern void shyguyblock(void);
const BehaviorScript bhvShyGuyBlock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(shyguyblock_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 12000),
    BEGIN_LOOP(),
        CALL_NATIVE(shyguyblock),
    END_LOOP(),
};

extern void shyguysays(void);
const BehaviorScript bhvShyGuySays[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                     | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    LOAD_ANIMATIONS(oAnimations, Shyguysays_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(shyguysays),
    END_LOOP(),
};
...
const BehaviorScript bhvShyGuyBed[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(guybed_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(shyguybed),
    END_LOOP(),
};
...
const BehaviorScript bhvMoveCrate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(movecrate_collision),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(movecratecode),
    END_LOOP(),
};


extern void shyguycpt(void);
const BehaviorScript bhvShyGuyCaptain[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                     | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 205),
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP2),
    SET_INT(oDamageOrCoinValue, 2),
    LOAD_ANIMATIONS(oAnimations, shyguycaptain_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(shyguycpt),
    END_LOOP(),
};

extern void fallplatform(void);
const BehaviorScript bhvFallPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(fallplatform1_collision),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(fallplatform),
    END_LOOP(),
};

extern void lineplatform(void);
const BehaviorScript bhvLinePlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(lineplatform_collision),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(lineplatform),
    END_LOOP(),
};
extern void seagullcode(void);
const BehaviorScript bhvSeagull[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
    CALL_NATIVE(seagullcode),
    END_LOOP(),
};


extern void seaShell(void);
const BehaviorScript bhvSeaShell[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 70, /*Height*/ 100),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(seaShell),
    END_LOOP(),
};

extern void mechBowser(void);
const BehaviorScript bhvMechBowser[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HITBOX(/*Radius*/ 500, /*Height*/ 1150),
    LOAD_ANIMATIONS(oAnimations, mechbowser_anims),
    ANIMATE(0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(mechBowser),
    END_LOOP(),
};

const BehaviorScript bhvWindMill[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 20000),
    LOAD_ANIMATIONS(oAnimations, windmill_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
    END_LOOP(),
};
extern void bhv_azote(void);
extern void bhv_azote2(void);
const BehaviorScript bhvAzote[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_azote),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_azote2),
    ADD_INT(oAnimState, 1),
    END_LOOP(),
};
extern void icecube(void);
extern const Collision icecube_collision[];
const BehaviorScript bhvIceCube[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(icecube_collision),
    SET_HOME(),
    BEGIN_LOOP(),
    CALL_NATIVE(icecube),
    END_LOOP(),
};
extern void whale(void);
extern const Collision whale_collision[];
extern const struct Animation *const whale_anims[];
const BehaviorScript bhvWhale[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE| OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_COLLISION_DATA(whale_collision),
    LOAD_ANIMATIONS(oAnimations, whale_anims),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
    CALL_NATIVE(whale),
...
extern void waterspout(void);
extern const Collision whalespout_collision[];
const BehaviorScript bhvWaterSpout[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST)),
    LOAD_COLLISION_DATA(whalespout_collision),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 35, /*Height*/ 700),
    BEGIN_LOOP(),
    SET_INT(oInteractStatus, 0),
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(waterspout),
    END_LOOP(),
};


extern void icehexhoriz(void);
const BehaviorScript bhvIceQuadHoriz[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST),
    BEGIN_LOOP(),
    CALL_NATIVE(icehexhoriz),
    END_LOOP(),
};

const BehaviorScript bhvWhirlpoolNew[] = {
    BEGIN(OBJ_LIST_POLELIKE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
extern void cptlabyrinth(void);
const BehaviorScript bhvLabyrinthMusic[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(cptlabyrinth),
    END_LOOP(),
};

extern const struct Animation *const lungeFish_anims[];
extern void distrustfish(void);
const BehaviorScript bhvLungeFish[] = {
    BEGIN(OBJ_LIST_LEVEL),
    ...
    LOAD_ANIMATIONS(oAnimations, lungeFish_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 100, /*Gravity*/ -200, /*Bounciness*/ -10,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 190, /*Downwards offset*/ 80),
    SET_INT(oDamageOrCoinValue, 3),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(distrustfish),
    END_LOOP(),
};

extern void bowserBridge(void);
const BehaviorScript bhvChainBridge[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, chainbridge_anims),
    LOAD_COLLISION_DATA(chainbridge_collision),
    BEGIN_LOOP(),
        CALL_SEGMENTED(bowserBridge),
    END_LOOP(),
};

extern void chainEle(void);
const BehaviorScript bhvChainElevator[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(chianplatform_collision),
    BEGIN_LOOP(),
        CALL_SEGMENTED(chainEle),
    END_LOOP(),
};

extern ropeplatform(void);
const BehaviorScript bhvRopePlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(roperotate_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(ropeplatform),
    END_LOOP(),
};
extern bowsercart(void);
const BehaviorScript bhvBowserCart[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -400, /*Bounciness*/ 0,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(bowsercart_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(bowsercart),
    END_LOOP(),
};

void scaleByParam2(void);
extern checkpointflag(void);
...
extern treadmillyosh(void);
const BehaviorScript bhvYoshiWalking[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, yoshinew_anims),
    SET_HOME(),
    ANIMATE(2),
    BEGIN_LOOP(),
        CALL_NATIVE(treadmillyosh),
    END_LOOP(),
};

//lavafloor
extern lavafloorcode(void);
const BehaviorScript bhvLavaFloor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(lavafloor_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(lavafloorcode),
    END_LOOP(),
};

extern talkyoshiB1(void);
const BehaviorScript bhvYoshiTalkingB1[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, yoshinew_anims),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(talkyoshiB1),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern exploderock(void);
const BehaviorScript bhvExplodeRock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(bombwall_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(exploderock),
    END_LOOP(),
};


extern void mechBowserboss(void);
const BehaviorScript bhvMechBowserBoss[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SCALE(/*Unused*/ 0, /*Field*/ 140),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 750, /*Height*/ 1750, /*Downwards offset*/ 300),
    LOAD_ANIMATIONS(oAnimations, mechboss_anims),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(mechBowserboss),
    END_LOOP(),
};
extern void mechBossArm(void);
const BehaviorScript bhvMechArm[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, mechboss_anims),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(mechBossArm),
    END_LOOP(),
};


extern void bossplatform(void);
const BehaviorScript bhvBossPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(bossplatform_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_HOME(),
    SCALE(/*Unused*/ 0, /*Field*/ 82),
    BEGIN_LOOP(),
        CALL_NATIVE(bossplatform),
    END_LOOP(),
};

extern void clwonfoe(void);
const BehaviorScript bhvClownFoe[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(clowncarfoe_collision),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50,
                    /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(clwonfoe),
    END_LOOP(),
};
extern void breakinblock(void);
const BehaviorScript bhvBreakingBlock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(breakingblock_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(exploderock),
        //CALL_NATIVE(breakinblock),
    END_LOOP(),
};
extern void bonzaicode(void);
const BehaviorScript bhvBonzaiBob[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 165, /*Height*/ 250, /*Downwards offset*/ 5),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(bonzaicode),
    END_LOOP(),
};

extern void bowserbosscode(void);
const BehaviorScript bhvBossBOne[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bowserB1_anims),
   // ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(bowserbosscode),
    END_LOOP(),
};

extern void supernerd(void);
const BehaviorScript bhvTitleLakitu[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, lakitutitle_anims),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(supernerd),
    END_LOOP(),
};


const BehaviorScript bhvSolidUnitlB2Stars[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(bowserfightgate_collision),
    BEGIN_LOOP(),
     //   CALL_NATIVE(despawnonBparam1Stars),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
extern bowsercartOW(void);
const BehaviorScript bhvBowserCartOW[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -400, /*Bounciness*/ 0,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(bowsercartOW_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(bowsercartOW),
    END_LOOP(),
};


extern upcarpet(void);
const BehaviorScript bhvUpCarpet[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(upcarpet_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(upcarpet),
    END_LOOP(),
};



extern void bounceball(void);
const BehaviorScript bhvBounceBall[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 75, /*Height*/ 150, /*Downwards offset*/ 0),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(bounceball),
    END_LOOP(),
};
extern void fatYosherInit(void);
extern void fatyoshercode(void);
const BehaviorScript bhvFatYosher[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
   LOAD_ANIMATIONS(oAnimations, fatyosher_anims),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 225, /*Height*/ 300),
    CALL_NATIVE(yoshivillagerinitcode),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(fatyoshercode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern void lavarockCode(void);
const BehaviorScript bhvLavaRock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    BEGIN_LOOP(),
        CALL_NATIVE(lavarockCode),
    END_LOOP(),
};


extern void seesawRock(void);
const BehaviorScript bhvSeeSawRock[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_COLLISION_DATA(seesawrock_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(seesawRock),
    END_LOOP(),
};

extern void seesawPlank(void);
const BehaviorScript bhvSeeSawPlank[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_COLLISION_DATA(seesawplatform_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(seesawPlank),
    END_LOOP(),
};


extern void seesawSaurus(void);
const BehaviorScript bhvSeeSawSaurus[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
   LOAD_ANIMATIONS(oAnimations, diplosaurus_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 80, /*Gravity*/ -400, /*Bounciness*/ 0,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 310),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(seesawSaurus),
    SET_INT(oInteractStatus, 0),
    END_LOOP(),
};


extern void nessielava(void);
const BehaviorScript bhvNessieLava[] = {
    BEGIN(OBJ_LIST_SURFACE),
   ...
   LOAD_ANIMATIONS(oAnimations, nessie_anims),
    LOAD_COLLISION_DATA(nessie_collision),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(nessielava),
    END_LOOP(),
};


extern void diagshroom(void);
const BehaviorScript bhvBounceShroomDiag[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_COLLISION_DATA(bounceShroom_collision),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBounceShroom[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_COLLISION_DATA(bounceShroom2_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(diagshroom),
    END_LOOP(),
};
...
extern void geysircode(void);
const BehaviorScript bhvGeysir[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    BEGIN_LOOP(),
        CALL_NATIVE(geysircode),
    END_LOOP(),
};
extern void leafBendy(void);
const BehaviorScript bhvBendLeaf[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_DONT_CALC_COLL_DIST)),
    LOAD_COLLISION_DATA(bendleaf_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(leafBendy),
    END_LOOP(),
};
extern void swingVein(void);
...
extern void recnor(void);
const BehaviorScript bhvReznor[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_HOLDABLE)),
   LOAD_ANIMATIONS(oAnimations, reznor_anims),
    SET_HITBOX(/*Radius*/ 130, /*Height*/ 185),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 140, /*Gravity*/ -400, /*Bounciness*/ -20,
                    /*Drag strength*/ 500, /*Friction*/ 500, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(recnor),
    END_LOOP(),
...
extern void yoshiMama(void);
const BehaviorScript bhvYoshiMama[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, yoshimama_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiMama),
    END_LOOP(),
};

extern void babyegg(void);
const BehaviorScript bhvBabyYoshiEgg[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 200, /*Height*/ 300),
    SET_INT(oIntangibleTimer, 0),
...
extern void fakebush(void);
const BehaviorScript bhvFakeBush[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_DONT_CALC_COLL_DIST)),
    LOAD_COLLISION_DATA(fakebush_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(fakebush),
    END_LOOP(),
};


extern void yoshiDipshit1(void);
const BehaviorScript bhvDipshit1[] = {//schlorp
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 250, /*Height*/ 180),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 210, /*Gravity*/ -200, /*Bounciness*/ -10,
                    /*Drag strength*/ 500, /*Friction*/ 500, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oInteractStatus, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    LOAD_ANIMATIONS(oAnimations, yoshiDipshit1_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiDipshit1),
    END_LOOP(),
};

extern void yoshiDipshit2(void);
const BehaviorScript bhvDipshit2[] = { //spike
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 180, /*Height*/ 270),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 160, /*Gravity*/ -200, /*Bounciness*/ -10,
                    /*Drag strength*/ 500, /*Friction*/ 500, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oInteractStatus, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    LOAD_ANIMATIONS(oAnimations, dipshit2_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiDipshit2),
    END_LOOP(),
};


extern void yoshiDipshit3(void);
const BehaviorScript bhvDipshit3[] = {//bongo
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 200, /*Height*/ 355),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 180, /*Gravity*/ -200, /*Bounciness*/ -10,
                    /*Drag strength*/ 500, /*Friction*/ 500, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oInteractStatus, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    LOAD_ANIMATIONS(oAnimations, dipshit3_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiDipshit3),
    END_LOOP(),
};

extern void enginePart(void);
const BehaviorScript bhvEnginePart[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 50),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oInteractStatus, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(enginePart),
    END_LOOP(),
};

extern void crackedEgg(void);
const BehaviorScript bhvCrackedEgg[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 50, /*Height*/ 100),
    SET_INT(oIntangibleTimer, 0),
    ...
    SET_FLOAT(oGraphYOffset, 50),
    BEGIN_LOOP(),
        CALL_NATIVE(crackedEgg),
    END_LOOP(),
};

extern void dipshitStar(void);
const BehaviorScript bhvDipshitStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(dipshitStar),
    END_LOOP(),
};

extern void bigunagiCode(void);
const BehaviorScript bhvBigUnagi[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_ANIMATIONS(oAnimations, bigUnagi_anims),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bigunagiCode),
    END_LOOP(),
};

//bronchiosaurus: head moves ONLY, rest is not animated. put a geo_asm cmd that moves only the head. make the rest of this static collision triangles.
extern void bronchiocode(void);
const BehaviorScript bhvBronchioSaurus[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    LOAD_COLLISION_DATA(bronchiosaurus_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_ANIMATIONS(oAnimations, bronchiosaurus_anims),
    BEGIN_LOOP(),
        CALL_NATIVE(bronchiocode),
    END_LOOP(),
};

extern void sinkRocks(void);
const BehaviorScript bhvSinkingRocksR[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    BEGIN_LOOP(),
        CALL_NATIVE(sinkRocks),
    END_LOOP(),
};


extern void boulderbulkan(void);
const BehaviorScript bhvVulcanBoulder[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_HITBOX(/*Radius*/ 250, /*Height*/ 500),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oDamageOrCoinValue, 2),
    SCALE(0, 63),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 220, /*Gravity*/ -400, /*Bounciness*/ -15,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_FLOAT(oGraphYOffset, 250),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(boulderbulkan),
    END_LOOP(),
};


//bronchiosaurus: head moves ONLY, rest is not animated. put a geo_asm cmd that moves only the head. make the rest of this static collision triangles.
extern void trexcode(void);
const BehaviorScript bhvTyrannosaurus[] = {
    BEGIN(OBJ_LIST_LEVEL),
    ...
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_ANIMATIONS(oAnimations, trex_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 1000, /*Gravity*/ -400, /*Bounciness*/ -15,
                    /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX(/*Radius*/ 600, /*Height*/ 1070),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(trexcode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

void splashCode(void);
const BehaviorScript bhvLavaSplooshes[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(splashCode),
    END_LOOP(),
};
...
extern void bbarrelcode(void);
const BehaviorScript bhvBbarrel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(bbarrel_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    BEGIN_LOOP(),
        CALL_NATIVE(bbarrelcode),
    END_LOOP(),
};
extern void wingmillcode(void);
...
extern void camforce(void);
const BehaviorScript bhvCamForce[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(camforce),
    END_LOOP(),
};
