...
#define OBJ_FLAG_GET_FLOOR_HEIGHT                 (1 << 16) // 0x00010000, program it still
#define OBJ_FLAG_30                               (1 << 30) // 0x40000000
#define OBJ_FLAG_DONT_CALC_COLL_DIST              (1 << 31) // 0x80000000
...
/* Chain chomp */
    ...
    //CuckyDev: Moved to chain_chomp.inc.c
