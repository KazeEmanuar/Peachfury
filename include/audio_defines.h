...
#define SOUND_GENERAL_PAINTING_EJECT                        SOUND_ARG_LOAD(3, 9, 0x29, 0x00, 8)
...
/* not verified */ #define SOUND_GENERAL_RIGHT_ANSWER             SOUND_ARG_LOAD(3, 0, 0x6A, 0xA0, 8)
...
/* not verified */ #define SOUND_GENERAL_YOSHI_OW         SOUND_ARG_LOAD(3, 0, 0x77, 0x20, 8)
/* not verified */ #define SOUND_GENERAL_YOSHI_PAM         SOUND_ARG_LOAD(3, 0, 0x78, 0x20, 8)
/* not verified */ #define SOUND_GENERAL_YOSHI_WAAH         SOUND_ARG_LOAD(3, 0, 0x79, 0x20, 8)
/* not verified */ #define SOUND_GENERAL_YOSHI_WOAH         SOUND_ARG_LOAD(3, 0, 0x7A, 0x20, 8)
/* not verified */ #define SOUND_GENERAL_YOSHI_CAM         SOUND_ARG_LOAD(3, 0, 0x7B, 0x20, 8)
/* not verified */ #define SOUND_GENERAL_YOSHI_AWOWOWO         SOUND_ARG_LOAD(3, 0, 0x7C, 0x20, 8)
//unused: 77, 78, 79, 7a, 7b, 7c, 7d, 7e, 7f
// unused: 72, 53, 52, 51, 33, 32, 31, 2C, 2A, 29, 23, 21, 15, 14, 13, 10, 02, 01
...
/* not verified */ #define SOUND_ENV_THEAMAZON              SOUND_ARG_LOAD(4, 0, 0x19, 0x00, 0)
/* not verified */ #define SOUND_ENV_UNDERWATERCAVE         SOUND_ARG_LOAD(4, 0, 0x1A, 0x00, 0)
...
/* not verified */ #define SOUND_OBJ_UNKNOWN4               SOUND_ARG_LOAD(5, 0, 0x1E, 0xA0, 8) // swish noise
...
/* not verified */ #define SOUND_OBJ_WALKING_WATER          SOUND_ARG_LOAD(5, 0, 0x4F, 0x20, 8)
...
#define SOUND_OBJ_DORRIEWHALE                                    SOUND_ARG_LOAD(5, 0, 0x75, 0x60, 8)
/* not verified */ #define SOUND_OBJ_WHALEFALL      SOUND_ARG_LOAD(5, 2, 0x76, 0x10, 8)
#define SOUND_MECHBOWSER_HIT                               SOUND_ARG_LOAD(5, 0, 0x77, 0x40, 8)
#define SOUND_MECHBOWSER_INHALE                               SOUND_ARG_LOAD(5,0, 0x78, 0x00, 8)
#define SOUND_TREX_ROAT                               SOUND_ARG_LOAD(5,0, 0x79, 0x00, 8)
...
#define SOUND_AIR_PEACH_TWINKLE                 SOUND_ARG_LOAD(6, 0, 0x0B, 0x00, 0)
...
/* not verified */ #define SOUND_GENERAL_POUND_ROCK2         SOUND_ARG_LOAD(8, 0, 0x56, 0x00, 8)
...
#define SOUND_GENERAL2_WALL_EXPLOSION                        SOUND_ARG_LOAD(8, 0, 0x0F, 0x00, 8)
