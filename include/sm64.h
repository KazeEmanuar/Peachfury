...
#define MAXBREATH 800
#define BREATHMETERBAR 732
#include "types.h"
#include "config.h"
...
#include "macros.h"/*
__attribute__((always_inline)) inline void mtxf_to_mtx(register s16 *dest, register f32 *src) {
    testfunc(dest, src);
}*/
#define ICEFLOWERWALKOFFSTE 25.f
// Crash handler enhancement
#define CRASH_SCREEN_INCLUDED
...
#define INPUT_A_LAST_FRAME             0x1000
...
#define PARTICLE_20                   /* 0x00100000 */ (1 << 20)
#define PARTICLE_21                   /* 0x00200000 */ (1 << 21)
#define PARTICLE_22                   /* 0x00400000 */ (1 << 22)
#define PARTICLE_23                   /* 0x00800000 */ (1 << 23)
#define PARTICLE_24                   /* 0x01000000 */ (1 << 24)
#define PARTICLE_25                   /* 0x02000000 */ (1 << 25)
#define PARTICLE_26                   /* 0x04000000 */ (1 << 26)
#define PARTICLE_27                   /* 0x08000000 */ (1 << 27)
#define PARTICLE_28                   /* 0x10000000 */ (1 << 28)
#define PARTICLE_29                   /* 0x20000000 */ (1 << 29)
#define PARTICLE_30                   /* 0x40000000 */ (1 << 30)
#define PARTICLE_31                   /* 0x80000000 */ (1 << 31)
...
#define ACT_GRINDING                   0x0000047B // (0x07B | ACT_FLAG_MOVING)
#define ACT_RIDE_MINECART              0x2081047C // (0x046 | ACT_FLAG_MOVING | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING | ACT_FLAG_WATER_OR_TEXT)
...
#define ACT_WALL_SLIDE                  0x010208BF // (0x0BF | ACT_FLAG_AIR | ACT_FLAG_INVULNERABLE | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_HANG_LANTERN              0x08000350 // (0x150 | ACT_FLAG_STATIONARY | ACT_FLAG_ON_POLE | ACT_FLAG_PAUSE_EXIT)
...
static __attribute__((always_inline)) inline float sqrtf(float x) {
    float ret;
    __asm__("sqrt.s %0, %1" : "=f"(ret) : "f"(x));
    return ret;
}
#endif // SM64_H
