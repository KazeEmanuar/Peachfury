...
struct GraphNodeObject_sub
{
    ...
    /*0x04 0x4C*/ struct Animation *prevAnim;
    s16 curAnimFlags;
             f32 animPosStack[3];
...
struct MarioState
{
    ...
    /*0xC4*/ f32 unkC4;
    /*0xC8*/ Vec3f inertia;
    /*0xD4*/ struct MarioAnimation *animationSwap;
    /*0xD8*/ u8 animationSwapID;
    /*0xD9*/ u8 animIdSwap;
    /*0xDA*/ u8 animIDReal;
    /*0xDB*/ u8 animSwappedThisFrame;
    /*0xDC*/ f32 prevYvel;
    /*0xE0*/ f32 squishyness;
    /*0xE4*/ f32 squishSpeed;
    /*0xE8*/ u8 terrainParticleID;
    /*0xEC*/ struct Surface *wallPunched;
    /*0x70*/ f32 lastFloorHeight;
