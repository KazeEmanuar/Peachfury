...
#define vec3f_set(dest, x, y, z) {dest[0] = x;dest[1] = y;dest[2] = z;}
void *vec3f_add(Vec3f dest, Vec3f a);
void *vec3f_sum(Vec3f dest, Vec3f a, Vec3f b);
void *vec3s_copy(Vec3s dest, Vec3s src);
#define vec3s_set(dest, x, y, z) {dest[0] = x;dest[1] = y;dest[2] = z;}
...
//void mtxf_to_mtx(register s16 *dest,register f32 *src);
