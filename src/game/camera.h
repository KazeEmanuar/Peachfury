...
void transition_next_state(UNUSED struct Camera *c, s32 frames);
void set_camera_mode(struct Camera *c, s32 mode, s32 frames);
...
s32 collide_with_walls(Vec3f pos, f32 offsetY, f32 radius);
 s32 clamp_pitch(Vec3f from, Vec3f to, s32 maxPitch, s32 minPitch);
...
f32 camera_approach_f32_symmetric(f32 value, f32 target, f32 increment);
 void random_vec3s(Vec3s dst, s32 xRange, s32 yRange, s32 zRange);
...
void set_pitch_shake_from_point(s32 mag, s32 decay, s32 inc, f32 maxDist, f32 posX, f32 posY, f32 posZ);
...
void handle_c_button_movement(struct Camera *c);
 void start_cutscene(struct Camera *c, s32 cutscene);
 s32 get_cutscene_from_mario_status(struct Camera *c);
void warp_camera(f32 displacementX, f32 displacementY, f32 displacementZ);
void approach_camera_height(struct Camera *c, f32 goal, f32 inc);
void offset_rotated(Vec3f dst, Vec3f from, Vec3f to, Vec3s rotation);
 s32 next_lakitu_state(Vec3f newPos, Vec3f newFoc, Vec3f curPos, Vec3f curFoc, Vec3f oldPos, Vec3f oldFoc, s32 yaw);
...
void find_mario_floor_and_ceil(struct PlayerGeometry *pg);
 s32 start_object_cutscene_without_focus(s32 cutscene);
s32 cutscene_object_with_dialog(s32 cutscene, struct Object *o, s32 dialogID);
s32 cutscene_object_without_dialog(s32 cutscene, struct Object *o);
