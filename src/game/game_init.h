...
#define GFX_POOL_SIZE 0x4800

extern OSMesgQueue gGraphicsVblankQueue;
extern OSMesg gGraphicsMesg;
extern struct VblankHandler gGraphicsVblankHandler;
extern void thread9_graphics_loop(void);
extern f32 approach_pos(f32 current, f32 target);
...
extern OSMesg D_80339CD0[2];
extern OSMesg D_80339CD4;
extern struct VblankHandler gGameVblankHandler;
extern uintptr_t gPhysicalFrameBuffers[3];
extern uintptr_t gPhysicalZBuffer;
extern void *mAnimData;
...
extern struct MarioAnimation gmAnim;
extern struct MarioAnimation gmAnimSwap;
