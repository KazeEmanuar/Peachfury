...
#define obj_set_parent_relative_pos(obj, x, y, z)                                                      \
    (obj->oParentRelativePosX = x, obj->oParentRelativePosY = y, obj->oParentRelativePosZ = z);
#define obj_set_pos(obj, x, y, z) (obj->oPosX = x, obj->oPosY = y, obj->oPosZ = z);
...
static inline void obj_scale_xyz(struct Object *obj, f32 xScale, f32 yScale, f32 zScale) {
...
#define cur_obj_set_y_vel_and_animation(sp18, sp1C) {o->oVelY = sp18;cur_obj_init_animation_with_sound(sp1C);}
...
#define obj_mark_for_deletion(obj) mark_obj_for_deletion(obj)
