...
#define SAVE_FLAG_BUNNY_CAP           /* 0x040000 */ (1 << 21)
#define SAVE_FLAG_BOMB_CAP     /* 0x080000 */ (1 << 22)
#define SAVE_FLAG_DRY_CAP  /* 0x100000 */ (1 << 23)
...
extern void save_file_set_statetimer();
extern u32 save_file_get_statetimer();
extern u32 save_file_get_statetimer2();
