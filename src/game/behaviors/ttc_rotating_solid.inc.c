...
void bhv_ttc_rotating_solid_init(void) {
    ...
    o->oTTCRotatingSolidRotationDelay = sTTCRotatingSolidInitialDelays[0];
}
...
void bhv_ttc_rotating_solid_update(void) {
    ...
    if (0 != TTC_SPEED_STOPPED && o->oTimer > o->oTTCRotatingSolidRotationDelay) {
