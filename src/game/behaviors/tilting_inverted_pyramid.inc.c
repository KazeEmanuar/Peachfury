 ...
 */
void bhv_tilting_inverted_pyramid_loop(void) {//BROKEN
    f32 dx;
    f32 dy;
    f32 dz;
    f32 d;
    ...
    o->oTiltingPyramidNormalX = approach_by_increment(dx, o->oTiltingPyramidNormalX, incremental);
    o->oTiltingPyramidNormalY = approach_by_increment(dy, o->oTiltingPyramidNormalY, incremental);
    o->oTiltingPyramidNormalZ = approach_by_increment(dz, o->oTiltingPyramidNormalZ, incremental);
