...
void fish_act_spawn(void) {
    ...
    switch (o->oBehParams2ndByte) {
        ...
        case 4:
            model = MODEL_FISH;
            schoolQuantity = 8;
            minDistToMario = 5500.0f;
            fishAnimation = blue_fish_seg3_anims_0301C2B0;
            break;
        case 5:
            model = MODEL_FISH;
            schoolQuantity = 8;
            minDistToMario = 9500.0f;
            fishAnimation = blue_fish_seg3_anims_0301C2B0;
            break;
    }
    /**
     ...
     */
    if (o->oDistanceToMario < minDistToMario || gCurrLevelNum == LEVEL_CCM) {
...
void fish_act_respawn(void) {
    if (gCurrLevelNum != LEVEL_CCM) {
        if ((gMarioObject->oPosY - o->oPosY > 2000.0f)
            || (cur_obj_lateral_dist_from_mario_to_home() > 3500.f)) {
