...
struct Struct802C0DF0 sExclamationBoxContents[] = { { 0, 0, 0, MODEL_MARIOS_WING_CAP, bhvWingCap }, //wing cap
                                                    { 1, 0, 0, MODEL_MARIOS_METAL_CAP, bhvMetalCap }, //cloud cap
                                                    { 2, 0, 0, MODEL_MARIOS_CAP, bhvVanishCap },  // ice cap
                                                    { 3, 1, 1, MODEL_KOOPA_SHELL, bhvKoopaShell }, //bunny suit
                                                    { 4, 2, 2, 0x8D,
                                                      bhvNormalCap }, //bomb suit
                                                    { 5, 4, 4, MODEL_NONE, bhvThreeCoinsSpawn }, // dry mario suit
