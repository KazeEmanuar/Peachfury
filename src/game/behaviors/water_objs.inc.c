...
void bhv_water_air_bubble_loop(void) {
    s32 i;
    o->header.gfx.scale[0] = sins(o->oWaterObjUnkF4) * 0.5 + 6.0;
    o->header.gfx.scale[1] = -sins(o->oWaterObjUnkF4) * 0.5 + 6.0;
    ...
    if (o->oInteractStatus & INT_STATUS_INTERACTED || (o->oTimer > (46 + (o->oBehParams&0xff)))) {
