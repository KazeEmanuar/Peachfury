...
void cap_check_quicksand(void) {
    ...
    switch (SURFACETYPE(o->oFloorPointer)) {
        ...
        case SURFACE_MOVING_QUICKSAND:
            o->oAction = 11;
            o->oMoveAngleYaw = (o->oFloorPointer->force & 0xFF) << 8;
            o->oForwardVel = 8 + 2 * (0 - ((o->oFloorPointer->force & 0xFF00) >> 8));
            break;
...
void bhv_normal_cap_loop(void) {
    ...
    if (o->oTimer == 599) {
        o->activeFlags = 0;
        spawn_object(o, 0xCD, bhvExplosion);
    }
    if (o->oDistanceToMario < 150.f) {
        ...
        o->activeFlags = 0;
        powerupSystem2 |= o->oBehParams2ndByte;
        bombsleft = 5;
    }
}
