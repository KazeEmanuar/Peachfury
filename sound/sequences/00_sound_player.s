...
sound_ref .sound_action_jump_METAL49
sound_ref .sound_action_landing_metal
sound_ref .sound_action_step_metal
sound_ref .sound_action_jump_Wood4C
sound_ref .sound_action_landing_wood
sound_ref .sound_action_step_wood
sound_ref .useless
...
.sound_action_jump_METAL49:
chan_setbank 1
chan_setlayer 0, .layer_261m
chan_setlayer 1, .layer_261m2
chan_end
.layer_261m:
layer_setinstr 6
...
.layer_261m2:
layer_setinstr 7
layer_note1 36, 0xc, 40
layer_note1 45, 0x18, 40
layer_end

.sound_action_landing_metal:
chan_setbank 1
chan_setlayer 0, .layer_2DBm
chan_setlayer 1, .layer_2DBm2
chan_end
.layer_2DBm:
layer_setinstr 6
layer_note1 50, 0xc, 127
layer_note1 41, 0x18, 40
layer_end
.layer_2DBm2:
layer_setinstr 7
layer_note1 45, 0xc, 40
layer_note1 36, 0x18, 40
layer_end


.sound_action_step_metal:
chan_setbank 1
chan_setlayer 0, .layer_34Cm
chan_setlayer 1, .layer_34Cm2
chan_end
.layer_34Cm:
layer_setinstr 6
...
.layer_34Cm2:
layer_setinstr 7
layer_note1 39, 0x18, 35
layer_end


.sound_action_jump_Wood4C:
chan_setbank 1
chan_setinstr 9
chan_setlayer 0, .layer_234w
chan_end
.layer_234w:
layer_setinstr 0
layer_note1 41, 0xc, 160
layer_note1 46, 0x18, 160
layer_end

.sound_action_landing_wood:
chan_setbank 1
chan_setinstr 9
chan_setlayer 0, .layer_2AEw
chan_end
.layer_2AEw:
layer_note1 46, 0xc, 160
layer_note1 41, 0x18, 160
layer_end


.sound_action_step_wood:
chan_setbank 1
chan_setinstr 9
chan_setlayer 0, .layer_328w
chan_end
.layer_328w:
layer_note1 39, 0x18, 120
layer_end
...
sound_ref .sound_general_swish_air_highpitch
...
sound_ref .sound_general_boat_rock
  ...
  sound_ref .sound_general_yoshi_ow
  sound_ref .sound_general_yoshi_pam
  sound_ref .sound_general_yoshi_waah
  sound_ref .sound_general_yoshi_woah
  sound_ref .sound_general_yoshi_cam
  sound_ref .sound_general_yoshi_awowowo
  sound_ref .sound_general_boing2
  sound_ref .sound_general_yoshi_walk
  sound_ref .sound_general_enemy_alert1
...
.sound_general_swish_air_highpitch:
chan_setbank 0
chan_setinstr 0
chan_setlayer 0, .layer_178B_highpitch
chan_end

.layer_178B_highpitch:
layer_note1 48, 0x6, 100
layer_portamento 0x81, 44, 255
layer_note1 36, 0x12, 100
layer_end
...
.sound_general_yoshi_ow:
chan_setbank 0
chan_setinstr 6
chan_setlayer 0, .layer_1A35
chan_end

.sound_general_yoshi_pam:
chan_setbank 0
chan_setinstr 7
chan_setlayer 0, .layer_1A35
chan_end

.sound_general_yoshi_waah:
chan_setbank 0
chan_setinstr 8
chan_setlayer 0, .layer_1A35
chan_end

.sound_general_yoshi_woah:
chan_setbank 0
chan_setinstr 9
chan_setlayer 0, .layer_1A35
chan_end
...
sound_ref .sound_env_theamazon
sound_ref .sound_env_underwatercave
sound_ref .sound_env_droning1
sound_ref .sound_env_waterfall1
sound_ref .sound_env_waterfall1
sound_ref .sound_env_waterfall1
...
chan_call .set_reverb
chan_setenvelope .envelope_32C4
chan_setlayer 0, .layer_1B53eldorado
chan_end
...
layer_delay 0x4
.layer_1B56eldorado:
layer_note1 40, 0x90, 0x50
layer_jump .layer_1B56eldorado


.sound_env_underwatercave:
chan_setbank 0
chan_setinstr 6
chan_setval 25
chan_call .set_reverb
chan_setenvelope .envelope_32C4
chan_setlayer 0, .layer_1B53eldorado2
chan_end
...
layer_delay 0x4
.layer_1B56eldorado2:
layer_note1 40, 0x90, 0xcf
layer_jump .layer_1B56eldorado2
...
chan_setbank 5
chan_setinstr 15
chan_setlayer 0, .layer_staraura
chan_end

.layer_staraura:
layer_portamento 0x81, 43, 255
layer_note1 42, 150, 40
layer_jump .layer_staraura2
.layer_staraura2:
layer_portamento 0x81, 42, 255
layer_note1 43, 150, 40
layer_jump .layer_staraura
...
sound_ref .sound_obj_dorriewhale
sound_ref .sound_obj_whalefall
sound_ref .sound_obj_mechbowser_hit
sound_ref .sound_obj_mechbowser_inhalte
sound_ref .sound_obj_trex_roat
sound_ref .sound_obj_baby_penguin_walk
sound_ref .sound_obj_bowser_walk
sound_ref .sound_obj_bowser_roar
sound_ref .sound_obj_bowser_tail_pickup
...
chan_setval 10
chan_call .set_reverb
chan_setlayer 0, .layer_1FD8trex
chan_setlayer 1, .layer_1FD4trex
chan_end
...
.layer_1FD8trex:
layer_portamento 0x81, 19, 255
layer_note1 30, 0x5F, 255
layer_note1 36, 0x7f, 255
layer_end
...
.sound_obj_whalefall:
chan_setbank 2
chan_setlayer 0, .layer_236Awhalke
chan_setlayer 1, .layer_2374whale
chan_setdecayrelease 127
chan_end
...
layer_setinstr 1
.layer_2374whale2:
layer_note1 38, 0x12c, 54
layer_end




.sound_obj_mechbowser_hit:
chan_setbank 6
chan_setlayer 0, .layer_236Amech
chan_setlayer 1, .layer_2374mech
chan_setlayer 2, .layer_2373mech
chan_setdecayrelease 127
chan_end
...
layer_setinstr 11
layer_portamento 0x81, 12, 255
layer_note1 39, 0xff, 255
layer_end

.layer_2374mech:
layer_somethingon
layer_setinstr 3
layer_note1 32, 0x12c, 127
layer_end
...
.sound_obj_mechbowser_inhalte:
chan_setbank 6
chan_setinstr 6
chan_setlayer 0, .layer_236Amech
chan_setlayer 1, .layer_2006mech1
chan_setlayer 2, .layer_2006mech2
chan_end
...
.sound_obj_dorriewhale:
chan_setbank 6
chan_setinstr 4
chan_setval 63
chan_call .set_reverb
chan_setenvelope .envelope_32F4
chan_setlayer 0, .layer_23CDwhale
chan_end

.layer_23CDwhale:
layer_somethingon
layer_portamento 0x85, 192, 128
layer_note1 38, 0x18, 100
layer_note1 38, 0x14, 100
layer_note1 36, 0x1a, 100
layer_note1 40, 0x1A, 100
layer_note1 36, 0x1a, 100
layer_note1 40, 0x1A, 100
layer_note1 36, 0x1a, 100
layer_note1 40, 0x1A, 100
layer_note1 44, 0x1A, 100
layer_end
