...
const GeoLayout bbh_area_3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, bbh_dl_Cube_001_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bbh_dl_Plane_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, bbh_dl_Plane_025_mesh_layer_2),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bbh_dl_Plane_026_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
