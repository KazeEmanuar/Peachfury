Vtx windmill_Circle_001_mesh_layer_1_vtx_0[16] = {
...
Gfx windmill_Circle_001_mesh_layer_1_tri_0[] = {
	gsSPVertex(windmill_Circle_001_mesh_layer_1_vtx_0 + 0, 16, 0),
...
Gfx mat_windmill_f3d_material_015[] = {
	gsDPPipeSync(),
...
Gfx mat_revert_windmill_f3d_material_015[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
	gsSPEndDisplayList(),
};

Gfx windmill_Circle_001_mesh_layer_1[] = {
	gsSPDisplayList(mat_windmill_f3d_material_015),
	gsSPDisplayList(windmill_Circle_001_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_windmill_f3d_material_015),
	gsSPEndDisplayList(),
};
