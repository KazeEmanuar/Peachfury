...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YOSHI_STAR,              yoshistar_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_FISH,                    blue_fish_geo),
 ...
 //   LOAD_MODEL_FROM_GEO(MODEL_BURN_SMOKE_UNUSED,       burn_smoke_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_METAL_CAP,      cloudflowergeo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_WING_CAP,         marios_wing_cap_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIOS_CAP,              marios_metal_cap_geo),
	...
	LOAD_MODEL_FROM_GEO(0xf7, yoshinew_geo), 
    FREE_LEVEL_POOL(),
...
const LevelScript script_func_global_1[] = {
    ...
    //LOAD_MODEL_FROM_GEO(0xf0,      bouncyflower_geo),
    LOAD_MODEL_FROM_DL(0xf0, bouncyflower_Plane_mesh, LAYER_ALPHA),
    LOAD_MODEL_FROM_GEO(0xf1,      screw),
    LOAD_MODEL_FROM_GEO(0xf2,      wobblerock),
    LOAD_MODEL_FROM_GEO(0x8D,      bombflowergeo),
    LOAD_MODEL_FROM_GEO(0xf3,      cloudspawn),
    LOAD_MODEL_FROM_GEO(0xf4,     cloudchase),
    LOAD_MODEL_FROM_GEO(0xf5, icequad),
    //LOAD_MODEL_FROM_GEO(0xf6,      bitpipe_geo),
    LOAD_MODEL_FROM_DL(0xF6, bitpipe_Plane_mesh, LAYER_ALPHA),
    LOAD_MODEL_FROM_GEO(0xF8,      bombsprite_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BIRDS,      birds_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BIRDS2,      birds2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SPIDER,      spider_geo),
    LOAD_MODEL_FROM_GEO(MODEL_GRASSHOPPER,      grasshopper_geo),
    LOAD_MODEL_FROM_GEO(0xFD,      yoshiExclamationMark_geo),
    RETURN(),
};
...
const LevelScript script_func_global_13[] = {
    ...
    LOAD_MODEL_FROM_GEO(0x6A,                 savestateYosh_geo),
    RETURN(),
};
...
const LevelScript script_func_global_14[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SEAWEED,                 seaweed_geo2),
