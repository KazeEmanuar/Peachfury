...
const GeoLayout wf_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Circle_mesh),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, wf_dl_Circle_002_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_Circle_004_mesh),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, wf_dl_zzzshroom_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout wf_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 32768, 0, 0, 32768, -1, 0, geo_camera_main),
				GEO_OPEN_NODE(),
