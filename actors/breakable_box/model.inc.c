...
static const Vtx breakable_box_seg8_vertex_08012A90[] = {
    {{{  -100,      0,   -100}, 0, {   1984,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, {   1984,    1984}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,    1984}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, {     0,    1984}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,      0,    100}, 0, {   1984,    1984}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,    200,    100}, 0, {   1984,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   100,      0,   -100}, 0, {   1984,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   100,      0,    100}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -100,      0,    100}, 0, {     0,    1984}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -100,      0,   -100}, 0, {   1984,    1984}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,    200,    100}, 0, {     0,    1984}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,      0,    100}, 0, {   1984,    1984}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   100,      0,   -100}, 0, {   1984,      0}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x08012B80
static const Vtx breakable_box_seg8_vertex_08012B80[] = {
    {{{  -100,    200,    100}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, {   1984,    1984}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -100,    200,   -100}, 0, {   1984,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,    100}, 0, {     0,    1984}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   100,    200,   -100}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   100,      0,   -100}, 0, {     0,    1984}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,      0,   -100}, 0, {   1984,    1984}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,    200,   -100}, 0, {   1984,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -100,      0,   -100}, 0, {   1984,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -100,    200,    100}, 0, {     0,    1984}, {0x81, 0x00, 0x00, 0xff}}},
...
const Gfx breakable_box_seg8_dl_08012CD8[] = {
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_MIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_MIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_MIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_MIRROR, 5, G_TX_NOLOD),
