Lights1 bird_f3d_material_002_lights = gdSPDefLights1(
	0x22, 0x2F, 0x7F,
	0x44, 0x5E, 0xFE, 0x28, 0x28, 0x28);

Lights1 bird_f3d_material_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Lights1 bird_f3d_material_001_lights = gdSPDefLights1(
	0x7F, 0x3C, 0xD,
	0xFE, 0x78, 0x1A, 0x28, 0x28, 0x28);

Lights1 bird_f3d_material_003_lights = gdSPDefLights1(
	0x2F, 0x17, 0xE,
	0x5F, 0x2F, 0x1C, 0x28, 0x28, 0x28);

Gfx bird_unnamed_ia4_aligner[] = {gsSPEndDisplayList()};
u8 bird_unnamed_ia4[] = {
...
Vtx bird_Bone_mesh_layer_1_vtx_0[25] = {
...
Gfx bird_Bone_mesh_layer_1_tri_0[] = {
	gsSPVertex(bird_Bone_mesh_layer_1_vtx_0 + 0, 25, 0),
...
Vtx bird_Bone_mesh_layer_1_vtx_1[8] = {
...
Gfx bird_Bone_mesh_layer_1_tri_1[] = {
	gsSPVertex(bird_Bone_mesh_layer_1_vtx_1 + 0, 8, 0),
...
Vtx bird_Bone_mesh_layer_1_vtx_2[4] = {
...
Gfx bird_Bone_mesh_layer_1_tri_2[] = {
	gsSPVertex(bird_Bone_mesh_layer_1_vtx_2 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
	gsSP1Triangle(3, 0, 2, 0),
	gsSPEndDisplayList(),
};

Vtx bird_Bone_mesh_layer_1_vtx_3[54] = {
...
Gfx bird_Bone_mesh_layer_1_tri_3[] = {
	gsSPVertex(bird_Bone_mesh_layer_1_vtx_3 + 0, 30, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
	gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
	gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
	gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
	gsSP2Triangles(24, 25, 26, 0, 27, 28, 29, 0),
	gsSPVertex(bird_Bone_mesh_layer_1_vtx_3 + 30, 24, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
	gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
	gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
	gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
...
Vtx bird_bird_l_mesh_layer_1_vtx_0[4] = {
...
Gfx bird_bird_l_mesh_layer_1_tri_0[] = {
	gsSPVertex(bird_bird_l_mesh_layer_1_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
	gsSPEndDisplayList(),
};

Vtx bird_bird_r_mesh_layer_1_vtx_0[4] = {
...
Gfx bird_bird_r_mesh_layer_1_tri_0[] = {
	gsSPVertex(bird_bird_r_mesh_layer_1_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};


Gfx mat_bird_f3d_material_002[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT, TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, bird_unnamed_ia4),
	...
	gsSPSetLights1(bird_f3d_material_002_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_bird_f3d_material_002[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsSPEndDisplayList(),
};

Gfx mat_bird_f3d_material[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(bird_f3d_material_lights),
	gsSPEndDisplayList(),
};

Gfx mat_bird_f3d_material_001[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(bird_f3d_material_001_lights),
	gsSPEndDisplayList(),
};

Gfx mat_bird_f3d_material_003[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPClearGeometryMode(G_CULL_BACK),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(bird_f3d_material_003_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_bird_f3d_material_003[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_CULL_BACK),
	gsSPEndDisplayList(),
};

Gfx bird_Bone_mesh_layer_1[] = {
	gsSPDisplayList(mat_bird_f3d_material_002),
	gsSPDisplayList(bird_Bone_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_bird_f3d_material_002),
	gsSPDisplayList(mat_bird_f3d_material),
	gsSPDisplayList(bird_Bone_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_bird_f3d_material_001),
	gsSPDisplayList(bird_Bone_mesh_layer_1_tri_2),
	gsSPDisplayList(mat_bird_f3d_material_003),
	gsSPDisplayList(bird_Bone_mesh_layer_1_tri_3),
	gsSPDisplayList(mat_revert_bird_f3d_material_003),
	gsSPEndDisplayList(),
};

Gfx bird_bird_l_mesh_layer_1[] = {
	gsSPDisplayList(mat_bird_f3d_material_002),
	gsSPDisplayList(bird_bird_l_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_bird_f3d_material_002),
	gsSPEndDisplayList(),
};

Gfx bird_bird_r_mesh_layer_1[] = {
	gsSPDisplayList(mat_bird_f3d_material_002),
	gsSPDisplayList(bird_bird_r_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_bird_f3d_material_002),
	gsSPEndDisplayList(),
};
