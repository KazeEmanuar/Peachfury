   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_seg8_dl_080194384),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_seg8_dl_080194385),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, exclamation_box_seg8_dl_080194386),
