...
#include "actors/bubble/bubble.ia8.inc.c"
};
...
const Gfx bubble_seg4_dl_0401DD60[] = {
    ...
    gsDPLoadTextureBlock(bubble_seg4_texture_0401CD60, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
